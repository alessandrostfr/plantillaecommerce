        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                _this2.SubmitForm(); //nextTick sirve para esperar que luego se actualize el dom se ejecute una funcion.
    ...
    eliminarimagen: function eliminarimagen(imagen) {
      Swal.fire({
        ...
        if (result.value) {
          ...
          Swal.fire('Elimidado!', 'Tu archivo ha sido eliminado correctamente.', 'success');
        }
      });
    },
      ...
      if (this.slug) {
        ...
        axios.get(url).then(function (response) {
          ...
          if (data2.datos.nombre) {
            if (data2.datos.nombre === _this.nombre) {
              _this.deshabilitar_boton = 0;
              _this.div_mensajeslug = '';
              _this.div_clase_slug = '';
              _this.div_aparecer = false;
...
module.exports = __webpack_require__(/*! C:\xampp2\htdocs\ecommerce1\resources\js\app_admin.js */"./resources/js/app_admin.js");
