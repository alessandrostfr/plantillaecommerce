...
<div class="wrapper">
  <!-- Navbar -->
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
      ...
      <div id="api_search_autocomplete" style="position:relative">
        ...
        <form class="form-inline ml-3">
          <div class="input-group input-group-sm">
            ...
            <div class="input-group-append">
              <button id="miboton"  ref="SubmitButtonSearch"
        ...
        style="position:absolute; z-index:3;left:16px;">
          <ul class="list-group" style="align-items:left; justify-content:center;">
            <li class="list-group-item" v-for="resultado in resultados" style="position:relative;">
              <a href="#" class="dropdown-item" 
              v-on:click.prevent="select(resultado)">
                
                <span v-html="resultado.nombrenegrita"></span>
              </a>
            </li>
          </ul>
        </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Alessandro Staiano</a>
        </div>
      </div>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item" style="margin: 5%;">
                <form action="{{ route('admin.category.index', request()->get('nombre')) }}">                  

                  <div class="card-tools " style="margin-right: 30%;">
                    
                    <div class="input-group input-group-sm" style="widtg: 150px; margin-left: 10%;">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item" style="margin: 5%;">
                ...
                <form action="{{ route('admin.product.index', request()->get('nombre')) }}">                  
  ...
  <footer class="main-footer">
    ...
    <strong>Creado por <a href="">ASF</a>.</strong> Todos los derechos reservados.
  </footer>
