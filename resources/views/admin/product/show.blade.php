                  ...
                  @foreach ($producto->images as $image )
                    ...
                    <div  id="idimagen-{{$image->id}}" class="col-sm-2">
                      <a href="{{ $image->url }}" data-toggle="lightbox" data-title="Id: {{ $image->id }}" data-gallery="gallery" >
                        <img src="{{ $image->url }}"  class="img-fluid mb-2 rounded-circle" style="width: auto;height: auto; margin-top: 10px;"/>
                      </a>
                    </div>
          ...
          <div class="row">
                  ...
                  <div class="col-sm-6">
                        ...
                        <div class="custom-control custom-switch">
                          <input  disabled type="checkbox"                                                class="custom-control-input"                   id="sliderprincipal" 
          ...
          <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <a class="btn btn-danger" href="{{ URL::previous() }}">Cerrar</a>
                      {{-- <input 
